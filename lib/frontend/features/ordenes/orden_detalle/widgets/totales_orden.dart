...
/// y se esconde.
class TotalesOrden extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      children: [
        ...
        _CampoDescuento(ordenId: ordenId, editable: totales.editable),
...
/// estado en cada cambio a propósito: reescribir el campo mientras se teclea
...
class _CampoDescuento extends ConsumerStatefulWidget {
  const _CampoDescuento({required this.ordenId, required this.editable});
...
class _CampoDescuentoState extends ConsumerState<_CampoDescuento> {
  ...
  Widget build(BuildContext context) {
    final descuento = ref.watch(
      ordenEditorProvider(widget.ordenId)
