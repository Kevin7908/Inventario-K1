...
///
/// Para el repuesto que se consigue afuera o un cargo puntual. No hay lista que
/// mostrar, así que el panel izquierdo se convierte en dos campos y un botón.
///
/// Parámetros:
/// - [alAgregar]: recibe la descripción y el precio ya validados.
class LineaLibreForm extends StatefulWidget {
  const LineaLibreForm({super.key, required this.alAgregar});

  final void Function(String descripcion, int precio) alAgregar;

  @override
  State<LineaLibreForm> createState() => _LineaLibreFormState();
}

class _LineaLibreFormState extends State<LineaLibreForm> {
  ...
  Widget build(BuildContext context) {
    return PanelSeccion(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Para lo que no está en el catálogo: un repuesto que se consigue '
            'afuera o un cargo puntual.',
          ...
          CampoTexto(
            ...
            placeholder: 'Guardabarros trasero',
          ),
          ...
          ValueListenableBuilder<bool>(
            ...
            builder: (context, completo, _) => BotonPrimario(
              etiqueta: 'Agregar a la cotización',
              icono: Icons.add,
              alPresionar: completo ? _agregar : null,
            ),
          ),
        ],
      ),
